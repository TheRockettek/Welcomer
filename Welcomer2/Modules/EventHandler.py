        ...
        if not message.guild is None:
            ...
            if guildInfo['logging']['enable'] == True and ischannel(message.guild.channels,loggingChannel) and guildInfo['logging']['deleted-messages'] == True and (message.author.bot == False):
                ...
                try:
                    ...
                    print("Unable to send message on " + message.guild.name + " (" + str(message.guild.id) + ") MEMBER_DELETE")
            ...
            if guildInfo['logging']['enable'] == True and ischannel(after.guild.channels,loggingChannel) and guildInfo['logging']['edited-messages'] == True and (after.author.bot == False):
                if before.content != after.content:
                    ...
                    try:
                        ...
                        print("Unable to send message on " + after.guild.name + " (" + str(after.guild.id) + ") MEMBER_EDIT")
    ...
    async def on_channel_delete(self, channel):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(channel.guild.channels,loggingChannel) and guildInfo['logging']['deleted-channels'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + channel.guild.name + " (" + str(channel.guild.id) + ") CHANNEL_DELETE")
    ...
    async def on_channel_create(self, channel):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(channel.guild.channels,loggingChannel) and guildInfo['logging']['created-channels'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + channel.guild.name + " (" + str(channel.guild.id) + ") CHANNEL_CREATE")
        ...
        if guildInfo['logging']['enable'] == True and ischannel(after.guild.channels,loggingChannel) and guildInfo['logging']['edited-channels'] == True:
            ...
            if change == True:
                ...
                try:
                    ...
                    print("Unable to send message on " + after.guild.name + " (" + str(after.guild.id) + ") CHANNEL_EDIT")
    ...
    async def on_member_join(self, member):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(member.guild.channels,loggingChannel) and guildInfo['logging']['member-join'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + message.guild.name + " (" + message.guild.id + ") MEMBER_JOIN")
    ...
    async def on_member_remove(self, member):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(member.guild.channels,loggingChannel) and guildInfo['logging']['member-leave'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + message.guild.name + " (" + str(message.guild.id) + ") MEMBER_LEAVE")
            ...
            if guildInfo['logging']['enable'] == True and ischannel(after.guild.channels,loggingChannel) and guildInfo['logging']['member-edit'] == True:
                ...
                if change == True:
                    ...
                    try:
                        ...
                        print("Unable to send message on " + after.guild.name + " (" + str(after.guild.id) + ") MEMBER_UPDATE")
...
***We now support custom backgrounds!***
- Do +welcomer custom
- Send a png image as an attachment in the next message
- Thats all there is to it!

**Support the bot by upvoting at https://discordbots.org/bot/330416853971107840. It lets us know you like it, it makes it more popular and lets you unlock custom images**

**Join the support guild : https://discord.gg/E6gnrgp**""")
        message = ""
        ...
        embed = discord.Embed(title=guild.name + " (" + str(guild.id) + ") has added our bot :)", colour=discord.Colour((0xffff00 if len(guild.members) > 200 else 0x00ff00)), description=message, timestamp=datetime.utcfromtimestamp(time.time()))
        try:
            embed.set_thumbnail(url=guild.icon_url)
        except:
            0
        if len(guild.members) > 100:
            await self.bot.get_channel(int(373775286812278784)).send(embed=embed)
        else:
    ...
    async def on_guild_role_create(self, role):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(role.guild.channels,loggingChannel) and guildInfo['logging']['server-role-create'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + role.guild.name + " (" + str(role.guild.id) + ") ROLE_CREATE")
    ...
    async def on_guild_role_delete(self, role):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(role.guild.channels,loggingChannel) and guildInfo['logging']['server-role-delete'] == True:
            ...
            try:
                ...
                print("Unable to send file on " + role.guild.name + " (" + str(role.guild.id) + ") ROLE_DELETE")
        ...
        if guildInfo['logging']['enable'] == True and ischannel(after.guild.channels,loggingChannel) and guildInfo['logging']['server-role-edit'] == True:
            ...
            if change == True:
                ...
                try:
                    ...
                    print("Unable to send message on " + after.guild.name + " (" + str(after.guild.id) + ") ROLE_EDIT")
    ...
    async def on_member_ban(self, guild, member):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(guild.channels,loggingChannel) and guildInfo['logging']['member-ban'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + guild.name + " (" + str(guild.id) + ") MEMBER_BAN")
    ...
    async def on_member_unban(self, guild, member):
        ...
        if guildInfo['logging']['enable'] == True and ischannel(guild.channels,loggingChannel) and guildInfo['logging']['member-unban'] == True:
            ...
            try:
                ...
                print("Unable to send message on " + guild.name + " (" + str(guild.id) + ") MEMBER_UNBAN")
