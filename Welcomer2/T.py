...
import asyncio, discord, time, os, shutil, requests, json, psutil, math
...
global bot
bot = commands.AutoShardedBot(command_prefix="+",pm_help=True)
global blockedusers
...
print("Starting...")
bot.run("MzMwNDE2ODUzOTcxMTA3ODQw.DOraZA.KPcgvt1Y8SSvh0BZCgAku4tOVYM")